<div class="field button">
    <a href="index.php?controller=user&task=showUsers"><input class="btnAdd" type="submit" value="Liste d'utilisateurs"></a>
    <a href="index.php?controller=user&task=pageCreateUser"><input class="btnAdd" type="submit" value="Création d'utilisateurs"></a>
    ...
    <a href="index.php?controller=articles&task=allow"><input class="btnAdd" type="submit" value="Autorisations"></a>
</div>